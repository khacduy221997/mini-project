package grass.micro.apps.auth.persistence;
...
@Configuration
@EnableJpaRepositories(basePackages = "grass.micro.apps.dao.auth",
        entityManagerFactoryRef = "authEntityManager", transactionManagerRef = "authTransactionManager")
public class AuthPersistenceConfigurer {
    @Autowired
    ...
    public LocalContainerEntityManagerFactoryBean authEntityManager() {
        ...
        em.setPackagesToScan(new String[] { "grass.micro.apps.model.auth", "grass.micro.apps.model.base" });
