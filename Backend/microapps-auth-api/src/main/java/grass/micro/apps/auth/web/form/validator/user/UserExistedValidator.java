...
@Component
public class UserExistedValidator extends AbstractFormValidator {
    ...
    public boolean doValidate(Serializable form, Errors errors) {
        ...
        if (user == null) {
            errors.reject(ErrorCode.APP_2053_USER_IS_NOT_EXISTED, new Object[] {"" + id}, ErrorCode.APP_2053_USER_IS_NOT_EXISTED);
        }
